package com.mct.logcatwindow.test;
...
import com.mct.logcatwindow.LogWindowService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_show_logcat).setOnClickListener(v -> {
            Utils.requestOverlayPermission(this, (allGranted, gl, dl) -> {
                if (allGranted) {
                    String key = LogWindowService.EXTRA_CUTOUT_SAFE_AREA;
                    final Intent intent = new Intent(this, LogWindowService.class);
